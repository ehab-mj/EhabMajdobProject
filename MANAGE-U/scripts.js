...
function showTasksInList() {
 ...
 <div class="d-flex flex-direction-row">
    ...
    <i class="fa-solid fa-check" style="color: #ffffff;"onclick="Completed(${task.id})"></i>
    </button>

    <button class="btn btn-primary">
    <i class="fa-solid fa-pen" style="color: #ffffff;" onclick="Edit(${task.id})">
    </i></button> 

    <button class="btn btn-danger">
    <i class="fa-solid fa-trash" style="color: #ffffff;"onclick="deleteTask(${task.id})"></i>
    </button>
    ...
    <button class="btn btn-primary">
    <i class="fa-solid fa-pen" style="color: #ffffff;" onclick="Edit(${task.id})"></i>
    </button> 
